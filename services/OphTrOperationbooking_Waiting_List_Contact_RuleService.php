...
class OphTrOperationbooking_Waiting_List_Contact_RuleService extends \services\DeclarativeModelService
{
	...
	static protected $primary_model = 'OphTrOperationbooking_Waiting_List_Contact_Rule';

	static public $model_map = array(
		'OphTrOperationbooking_Waiting_List_Contact_Rule' => array(
			'fields' => array(
				...
				'service_ref' => array(self::TYPE_REF, 'service_id', 'Service'),
