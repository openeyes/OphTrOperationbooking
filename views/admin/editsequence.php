...
<div class="box admin">
	...
	<div id="OphTrOperationbooking_Operation_Sequence_week_selection" class="row field-row">
		...
		<div class="large-5 column end">
			...
			<label class="inline"><input type="checkbox" name="OphTrOperationbooking_Operation_Sequence[week_selection_week1]" value="1" <?php if ($sequence->week_selection & 1) {?> checked="checked"<?php }?>/> 1st</label>
			<label class="inline"><input type="checkbox" name="OphTrOperationbooking_Operation_Sequence[week_selection_week2]" value="1" <?php if ($sequence->week_selection & 2) {?> checked="checked"<?php }?>/> 2nd</label>
			<label class="inline"><input type="checkbox" name="OphTrOperationbooking_Operation_Sequence[week_selection_week3]" value="1" <?php if ($sequence->week_selection & 4) {?> checked="checked"<?php }?>/> 3rd</label>
			<label class="inline"><input type="checkbox" name="OphTrOperationbooking_Operation_Sequence[week_selection_week4]" value="1" <?php if ($sequence->week_selection & 8) {?> checked="checked"<?php }?>/> 4th</label>
			<label class="inline"><input type="checkbox" name="OphTrOperationbooking_Operation_Sequence[week_selection_week5]" value="1" <?php if ($sequence->week_selection & 16) {?> checked="checked"<?php }?>/> 5th</label>
		</div>
	</div>
	<?php $this->endWidget()?>
</div>
