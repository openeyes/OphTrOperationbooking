	...
	<?php
            if ($element->canChangeReferral()) {
				...
				<div class="large-2 column">
					<label for="Element_OphTrOperationbooking_Operation_referral_id"><?= $element->getAttributeLabel('referral_id');
                ?></label>
				</div>
                ...
                ?>
					...
					<div class="large-4 column end"><?php if ($element->referral) {
