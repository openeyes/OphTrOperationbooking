...
<?php $this->beginWidget('CActiveForm', array('id'=>'session_form'.$session->id, 'action'=>Yii::app()->createUrl('/OphTrOperationbooking/theatreDiary/saveSession'), 'enableAjaxValidation'=>false))?>
	<div class="action_options diaryViewMode" data-id="<?php echo $session->id?>" style="float: right;">
		...
		<div class="session_options diaryEditMode" data-id="<?php echo $session->id?>" style="display: none;">
	...
	<div class="theatre-sessions whiteBox clearfix">
		...
		<div style="display: none;" data-id="<?php echo $session->id?>" class="classy_buttons diaryEditMode">
			...
			<button type="submit" class="classy green mini" id="btn_edit_session_save_<?php echo $session->id?>"><span class="button-span button-span-green">Save changes to session</span></button>
			<button type="submit" class="classy red mini" id="btn_edit_session_cancel_<?php echo $session->id?>"><span class="button-span button-span-red">Cancel</span></button>
		</div>
	</div>
<?php $this->endWidget()?>
