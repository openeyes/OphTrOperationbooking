...
<?php $this->beginContent('//patient/event_container'); ?>
	...
	<div class="schedule">
		...
		<div class="alert-box alert with-icon<?php if (!is_array($errors)) {
    ?> hide<?php 
}?>">
    ...
    ?>
			<div class="eventDetail">
				<strong>Operation duration:</strong> <?php echo $operation->total_duration;
    ?> minutes
			</div>
			<div class="eventDetail">
            ...
            if ($initial_erod || $erod) {
				...
				<div class="eventDetail">
					...
					<div class="row field-row">
						...
						<div class="large-5 column end data"><?php if ($erod) {
