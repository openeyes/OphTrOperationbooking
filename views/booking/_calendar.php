		...
		<tr>
			<td colspan="8">
				...
				<span>Key:</span>
					...
					<?php if (Yii::app()->params['ophtroperationboooking_rtt_limit']) {?><div class="container" id="outside_rtt"><div class="color_box"></div><div class="label">Outside RTT</div></div><?php } ?>
