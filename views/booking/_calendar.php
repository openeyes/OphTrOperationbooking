...
<table id="calendar">
    ...
    ?>
						<td class="<?php echo $session['status']?><?php if ($date == $selectedDate) {
    ?> selected_date<?php 
}
    ?>">
    ...
    ?><div class="container" id="outside_rtt"><div class="color_box"></div><div class="label">Outside RTT</div></div><?php 
} ?>
