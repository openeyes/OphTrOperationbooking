...
class m121128_150949_admission_letter_warning_rules extends CDbMigration
{
	public function up()
	{
		$this->createTable('ophtroperationbooking_admission_letter_warning_rule_type', array(
		...
		$this->createTable('ophtroperationbooking_admission_letter_warning_rule', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
	...
	{
		$this->dropTable('ophtroperationbooking_admission_letter_warning_rule');
		$this->dropTable('ophtroperationbooking_admission_letter_warning_rule_type');
	}
}
