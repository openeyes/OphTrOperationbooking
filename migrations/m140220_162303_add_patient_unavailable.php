...
class m140220_162303_add_patient_unavailable extends CDbMigration
{
	public function up()
	{
		...
		$this->addForeignKey('ophtroperationbooking_scheduleope_patientunavailreas_lmui_fk',
				'ophtroperationbooking_scheduleope_patientunavailreason',
				'last_modified_user_id', 'user', 'id');
		$this->addForeignKey('ophtroperationbooking_scheduleope_patientunavailreas_cui_fk',
				'ophtroperationbooking_scheduleope_patientunavailreason',
		...
		$this->addForeignKey('ophtroperationbooking_scheduleope_patientunavail_lmui_fk',
				'ophtroperationbooking_scheduleope_patientunavail',
				'last_modified_user_id', 'user', 'id');
		$this->addForeignKey('ophtroperationbooking_scheduleope_patientunavail_cui_fk',
				'ophtroperationbooking_scheduleope_patientunavail',
				'created_user_id', 'user', 'id');
		$this->addForeignKey('ophtroperationbooking_scheduleope_patientunavail_ri_fk',
				'ophtroperationbooking_scheduleope_patientunavail',
				'reason_id', 'ophtroperationbooking_scheduleope_patientunavailreason', 'id');
		$this->addForeignKey('ophtroperationbooking_scheduleope_patientunavail_ei_fk',
				'ophtroperationbooking_scheduleope_patientunavail',
