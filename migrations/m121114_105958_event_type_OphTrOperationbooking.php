...
class m121114_105958_event_type_OphTrOperationbooking extends CDbMigration
{
	public function up()
	{
		...
		if (!$this->dbConnection->createCommand()->select('id')->from('event_type')->where('class_name=:class_name', array(':class_name'=>'OphTrOperationbooking'))->queryRow()) {
			$group = $this->dbConnection->createCommand()->select('id')->from('event_group')->where('name=:name',array(':name'=>'Treatment events'))->queryRow();
			$this->insert('event_type', array('class_name' => 'OphTrOperationbooking', 'name' => 'Operation booking','event_group_id' => $group['id']));
		}
		// select the event_type id for this event type name
		$event_type = $this->dbConnection->createCommand()->select('id')->from('event_type')->where('class_name=:class_name', array(':class_name'=>'OphTrOperationbooking'))->queryRow();

		// create an element_type entry for this element type name if one doesn't already exist
		if (!$this->dbConnection->createCommand()->select('id')->from('element_type')->where('class_name=:class_name and event_type_id=:eventTypeId', array(':class_name'=>'Element_OphTrOperationbooking_Diagnosis',':eventTypeId'=>$event_type['id']))->queryRow()) {
			$this->insert('element_type', array('name' => 'Diagnosis','class_name' => 'Element_OphTrOperationbooking_Diagnosis', 'event_type_id' => $event_type['id'], 'display_order' => 1));
		}
		// select the element_type_id for this element type name
		$element_type = $this->dbConnection->createCommand()->select('id')->from('element_type')->where('event_type_id=:eventTypeId and class_name=:class_name', array(':eventTypeId'=>$event_type['id'],':class_name'=>'Element_OphTrOperationbooking_Diagnosis'))->queryRow();
		...
		// create an element_type entry for this element type name if one doesn't already exist
		if (!$this->dbConnection->createCommand()->select('id')->from('element_type')->where('class_name=:class_name and event_type_id=:eventTypeId', array(':class_name'=>'Element_OphTrOperationbooking_Operation',':eventTypeId'=>$event_type['id']))->queryRow()) {
			$this->insert('element_type', array('name' => 'Operation','class_name' => 'Element_OphTrOperationbooking_Operation', 'event_type_id' => $event_type['id'], 'display_order' => 1));
		}
		// select the element_type_id for this element type name
		$element_type = $this->dbConnection->createCommand()->select('id')->from('element_type')->where('event_type_id=:eventTypeId and class_name=:class_name', array(':eventTypeId'=>$event_type['id'],':class_name'=>'Element_OphTrOperationbooking_Operation'))->queryRow();
		...
		// create an element_type entry for this element type name if one doesn't already exist
		if (!$this->dbConnection->createCommand()->select('id')->from('element_type')->where('class_name=:class_name and event_type_id=:eventTypeId', array(':class_name'=>'Element_OphTrOperationbooking_ScheduleOperation',':eventTypeId'=>$event_type['id']))->queryRow()) {
			$this->insert('element_type', array('name' => 'Schedule operation','class_name' => 'Element_OphTrOperationbooking_ScheduleOperation', 'event_type_id' => $event_type['id'], 'display_order' => 1));
		}
		// select the element_type_id for this element type name
		$element_type = $this->dbConnection->createCommand()->select('id')->from('element_type')->where('event_type_id=:eventTypeId and class_name=:class_name', array(':eventTypeId'=>$event_type['id'],':class_name'=>'Element_OphTrOperationbooking_ScheduleOperation'))->queryRow();

		// create the table for this element type: et_modulename_elementtypename
		$this->createTable('et_ophtroperationbooking_diagnosis', array(
		...
		// element lookup table et_ophtroperationbooking_operation_priority
		$this->createTable('ophtroperationbooking_operation_priority', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->insert('ophtroperationbooking_operation_priority',array('name'=>'Routine','display_order'=>1));
		$this->insert('ophtroperationbooking_operation_priority',array('name'=>'Urgent','display_order'=>2));

		$this->createTable('ophtroperationbooking_operation_status', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->insert('ophtroperationbooking_operation_status',array('id'=>1,'name'=>'Requires scheduling'));
		$this->insert('ophtroperationbooking_operation_status',array('id'=>2,'name'=>'Scheduled'));
		$this->insert('ophtroperationbooking_operation_status',array('id'=>3,'name'=>'Requires rescheduling'));
		$this->insert('ophtroperationbooking_operation_status',array('id'=>4,'name'=>'Rescheduled'));
		$this->insert('ophtroperationbooking_operation_status',array('id'=>5,'name'=>'Cancelled'));

		$this->createTable('ophtroperationbooking_operation_cancellation_reason', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		// create the table for this element type: et_modulename_elementtypename
		$this->createTable('et_ophtroperationbooking_operation', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
				'event_id' => 'int(10) unsigned NOT NULL',
				'eye_id' => 'int(10) unsigned NOT NULL DEFAULT 1', // Eyes
		...
		$this->createTable('ophtroperationbooking_operation_date_letter_sent', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->createTable('ophtroperationbooking_operation_theatre', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->createTable('ophtroperationbooking_operation_ward', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
				'site_id' => 'int(10) unsigned NOT NULL',
				...
				'KEY `ophtroperationbooking_operation_ward_thi_fk` (`theatre_id`)',
				...
				'CONSTRAINT `ophtroperationbooking_operation_ward_thi_fk` FOREIGN KEY (`theatre_id`) REFERENCES `ophtroperationbooking_operation_theatre` (`id`)',
			), 'ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin');

		$this->createTable('ophtroperationbooking_operation_sequence_interval', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->insert('ophtroperationbooking_operation_sequence_interval',array('id'=>1,'name'=>'Once'));
		$this->insert('ophtroperationbooking_operation_sequence_interval',array('id'=>2,'name'=>'1 week'));
		$this->insert('ophtroperationbooking_operation_sequence_interval',array('id'=>3,'name'=>'2 weeks'));
		$this->insert('ophtroperationbooking_operation_sequence_interval',array('id'=>4,'name'=>'3 weeks'));
		$this->insert('ophtroperationbooking_operation_sequence_interval',array('id'=>5,'name'=>'4 weeks'));
		$this->insert('ophtroperationbooking_operation_sequence_interval',array('id'=>6,'name'=>'Monthly'));

		$this->createTable('ophtroperationbooking_operation_sequence', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->createTable('ophtroperationbooking_operation_session', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->createTable('ophtroperationbooking_operation_erod', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->createTable('ophtroperationbooking_operation_erod_rule', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->createTable('ophtroperationbooking_operation_erod_rule_item', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
		...
		$this->createTable('ophtroperationbooking_operation_booking', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
				'element_id' => 'int(10) unsigned NOT NULL',
		...
		$this->createTable('ophtroperationbooking_operation_procedures_procedures', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
				'element_id' => 'int(10) unsigned NOT NULL',
		...
		// element lookup table ophtroperationbooking_scheduleope_schedule_options
		$this->createTable('ophtroperationbooking_scheduleope_schedule_options', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
				'name' => 'varchar(128) COLLATE utf8_bin NOT NULL',
				'display_order' => 'int(10) unsigned NOT NULL DEFAULT 1',
				'last_modified_user_id' => 'int(10) unsigned NOT NULL DEFAULT 1',
		...
		$this->insert('ophtroperationbooking_scheduleope_schedule_options',array('name'=>'As soon as possible','display_order'=>1));

		// create the table for this element type: et_modulename_elementtypename
		$this->createTable('et_ophtroperationbooking_scheduleope', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
				'event_id' => 'int(10) unsigned NOT NULL',
		...
		$this->createTable('ophtroperationbooking_letter_contact_rule', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
	...
	public function down()
	{
		...
		$this->dropTable('ophtroperationbooking_operation_erod_rule_item');
		$this->dropTable('ophtroperationbooking_operation_erod_rule');
		$this->dropTable('ophtroperationbooking_operation_booking');
		$this->dropTable('ophtroperationbooking_operation_erod');
		$this->dropTable('ophtroperationbooking_operation_session');
		$this->dropTable('ophtroperationbooking_operation_sequence');
		$this->dropTable('ophtroperationbooking_operation_sequence_interval');
		$this->dropTable('ophtroperationbooking_operation_ward');
		$this->dropTable('ophtroperationbooking_operation_theatre');
		$this->dropTable('ophtroperationbooking_operation_date_letter_sent');
		$this->dropTable('et_ophtroperationbooking_operation');
		$this->dropTable('ophtroperationbooking_operation_status');
		$this->dropTable('ophtroperationbooking_operation_cancellation_reason');
		$this->dropTable('ophtroperationbooking_operation_priority');
		$this->dropTable('et_ophtroperationbooking_scheduleope');
		$this->dropTable('ophtroperationbooking_scheduleope_schedule_options');
...
*/
		...
		$element_operation = Yii::app()->db->createCommand("select * from element_type where event_type_id={$event_type['id']} and class_name = 'Element_OphTrOperationbooking_Operation'")->queryRow();
		$element_diagnosis = Yii::app()->db->createCommand("select * from element_type where event_type_id={$event_type['id']} and class_name = 'Element_OphTrOperationbooking_Diagnosis'")->queryRow();
		$element_schedule = Yii::app()->db->createCommand("select * from element_type where event_type_id={$event_type['id']} and class_name = 'Element_OphTrOperationbooking_ScheduleOperation'")->queryRow();
