...
class m121114_105958_event_type_OphTrOperation extends CDbMigration
{
	public function up() {
		...
		$this->createTable('ophtroperation_letter_contact_rule', array(
				'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
				...
				'created_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
				'PRIMARY KEY (`id`)',
				'KEY `ophtroperation_letter_contact_rule_pi_fk` (`parent_rule_id`)',
				'KEY `ophtroperation_letter_contact_rule_site_id_fk` (`site_id`)',
				'KEY `ophtroperation_letter_contact_rule_subspecialty_id_fk` (`subspecialty_id`)',
				'KEY `ophtroperation_letter_contact_rule_theatre_id_fk` (`theatre_id`)',
				'KEY `ophtroperation_letter_contact_rule_firm_id_fk` (`firm_id`)',
				'KEY `ophtroperation_letter_contact_rule_lmui_fk` (`last_modified_user_id`)',
				'KEY `ophtroperation_letter_contact_rule_cui_fk` (`created_user_id`)',
