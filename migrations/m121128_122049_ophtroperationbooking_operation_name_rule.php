...
class m121128_122049_ophtroperationbooking_operation_name_rule extends CDbMigration
{
	public function up()
	{
		$this->createTable('ophtroperationbooking_operation_name_rule', array(
				...
				'CONSTRAINT `ophtroperationbooking_operation_name_r_lmui_fk` FOREIGN KEY (`created_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `ophtroperationbooking_operation_name_r_cid_fk` FOREIGN KEY (`last_modified_user_id`) REFERENCES `user` (`id`)'
			),
