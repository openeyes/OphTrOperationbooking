...
class OphTrOperationbooking_Operation_Booking extends BaseActiveRecordVersioned
{
	...
	public function relations()
	{
		...
		return array(
			...
			'cancellationReason' => array(self::BELONGS_TO, 'OphTrOperationbooking_Operation_Cancellation_Reason', 'cancellation_reason_id', 'order' => 'name'),
	...
	protected function afterSave()
	{
		Yii::app()->event->dispatch(
			...
			array(
				...
				'site' => $this->ward ? $this->ward->site : $this->theatre->site,
				'ward_code' => $this->ward ? $this->ward->code : '',
