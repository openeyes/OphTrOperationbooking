...
class Element_OphTrOperationbooking_Operation extends BaseEventTypeElement
{
			...
			$reschedule=false, $cancellation_data = null, $schedule_op = null)
	{
		...
		// If left true this will break horribly
